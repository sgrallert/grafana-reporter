...
SRC:=$(GOPATH)/src/github.com/sgrallert/reporter
...
.PHONY: build
build: 
	go install -v github.com/sgrallert/reporter/cmd/grafana-reporter

.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/sgrallert/reporter/cmd/grafana-reporter"
